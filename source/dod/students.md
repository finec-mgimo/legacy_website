...
Выбирала программу я очень долго. Выбор пал на мою программу, потому что здесь изучаются актуальные темы такие как big data, анализ данных - это все привлекает. И есть дальнейшее развитие в магистратуре - это искусственный интеллект. Также после бакалавриата я спокойно могу пойти работать и разработчиком, и в бизнес, потому что преподается все это на высшем уровне.
